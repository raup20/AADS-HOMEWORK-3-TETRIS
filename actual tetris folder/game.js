    ...
    // game constants
    //-------------------------------------------------------------------------
    var AGENT_MODE = "heuristic"; // other option: "beam"
    ...
    function keydown(ev) {
        var handled = false;
 //       if (ev.keyCode === 70) {   //fast forward when we press F.
     //   fastForward = !fastForward;
   //     return; 
 //   }
    if (ev.keyCode === 66) { // 'B' key
    AGENT_MODE = "beam";
    console.log("Switched to Beam Search agent");
}
if (ev.keyCode === 72) { // 'H' key
    AGENT_MODE = "heuristic";
    console.log("Switched to Heuristic agent");
}
    ...
    function lose() { show('start'); setVisualScore();     console.log("GAME OVER — score:", score, "rows:", rows); playing = false; }
   ...
   function setRows(n) {
    ...
    const newStep = Math.max(speed.min, speed.start - (speed.decrement * rows));
